...
channel-average multipliers needs live channel stats from the YouTube API) — primarily
videos over 1M views in the last 90 days, plus rarer 100x-multiplier breakouts when they
show up. That script only surfaces candidates; picking which ones cleanly translate into
...
of whether the original video's thumbnail did. This file is not a live API pull itself —
...
SWIPE_FILE = [
    ...
    {
        "title": "Convincing Stranger to Jump the Pier!",
        "channel": "Blake Bachert Shorts",
        "url": "https://www.youtube.com/watch?v=DWw0aS-gQ2w",
        "niche": "Street Dare/Social Pressure",
        "views": "1,166,074 (qualifies via the 1M+ absolute view floor)",
        "views_num": 1166074,
        "score": "1M+ views",
        "pattern": "A physical, escalating dare captured mid-negotiation, with a live caption implying a real-time countdown in progress.",
        "trigger": "Suspense (will he actually jump?) + social-pressure dynamics of watching one person talk another into something + the specificity of a real, named dare making it feel grounded rather than staged.",
        "thumbnail": "Two men on a wooden pier with an ocean/city skyline background, one mid-gesture with his arm extended toward the water, a small \"count\" caption overlay implying a countdown in progress, bright casual daylight.",
        "formula": "\"Convincing [Target] to [Escalating Physical Dare]!\"",
        "why": "The countdown caption turns a simple dare into a ticking-clock moment, and naming a specific, real dare (a real pier, not something vague) makes the stakes concrete and visualizable before clicking.",
        "translation": "Reframe \"convincing a stranger to jump off a pier\" as \"convincing a stranger to agree to something bold in the moment\" — same countdown/dare tension, aimed at a social ask instead of a physical stunt.",
        "ca_title": "Convincing A Stranger To Skip Her Plans And Come Get Ice Cream With Me",
        "ca_thumbnail": "Creator and a woman together on a boardwalk or pier, creator mid-gesture with arm extended playfully, the woman smiling and visibly hesitating mid-decision as the clear co-lead of the frame, a small \"count\" caption overlay implying a countdown, bright daylight beach or city backdrop.",
        "notes": "The live \"countdown\" caption device is a cheap, reusable way to add ticking tension to any dare-based approach video.",
        "status": "Not Adapted",
    },
    {
        "title": "Struggling Father Gives Last $1 So I Gave Him $200,000",
        "channel": "MDMotivator",
        "url": "https://www.youtube.com/watch?v=YlTORlNPM_8",
        "niche": "Reward/Surprise Philanthropy",
        "views": "3,901,844 (qualifies via the 1M+ absolute view floor)",
        "views_num": 3901844,
        "score": "1M+ views",
        "pattern": "An extreme before/after dollar-figure escalation (\"last $1\" to \"$200,000\") paired with a literal, oversized physical reward reveal visible directly in the thumbnail.",
        "trigger": "Moral contrast (someone with almost nothing being astonishingly overpaid back) + the aspirational \"good things happen to good people\" payoff + a reward made literally, physically enormous and visible.",
        "thumbnail": "A smiling young man in the foreground, two people with blurred faces in the mid-ground, a truck wrapped with a giant red bow and stacks of cash bundles visible behind them, warm daylight parking-lot setting.",
        "formula": "\"[Someone] Gives Last $[Small Amount] So I Gave [Them] $[Huge Amount]\"",
        "why": "The extreme numerical contrast does the emotional work in the title alone, and showing the literal physical reward in the thumbnail makes the payoff instantly legible without needing to watch first.",
        "translation": "Reframe \"someone gives their last dollar so I gave them a fortune\" as \"someone gave me genuine attention despite having every reason not to, so I gave them something unforgettable back\" — same extreme-contrast + literal-reveal formula, aimed at a social/emotional reward instead of a purely financial one.",
        "ca_title": "She Gave Me A Chance Even Though Every Guy Before Me Got Rejected, So I Did This",
        "ca_thumbnail": "Creator smiling in the foreground, a woman with a surprised, emotional expression front-and-center in the mid-ground as the clear focal point, a visible oversized surprise (a large wrapped gift or a dramatic staged reveal) in the background, warm daylight setting mirroring the reward-reveal structure.",
        "notes": "The \"extreme numeric contrast + literal physical reveal in the thumbnail\" combo is a strong, reusable device independent of the specific reward type.",
        "status": "Not Adapted",
    },
    {
        "title": "Asking STRANGERS To Transform Their House… For FREE",
        "channel": "RUDAN BROTHERS",
        "url": "https://www.youtube.com/watch?v=XiO-V1CVPgo",
        "niche": "Generosity/Direct-Address Favor",
        "views": "4,298,340 (qualifies via the 1M+ absolute view floor)",
        "views_num": 4298340,
        "score": "1M+ views",
        "pattern": "A direct-address favor request captured mid-ask, aimed at a real, visibly-in-need stranger, with the visible \"before\" state doing double duty as both hook and implicit promise of a dramatic reveal later.",
        "trigger": "Generosity anticipation (we know a transformation is coming) + a real visible \"before\" state making the eventual payoff feel earned and concrete + a direct-address caption making the viewer feel spoken to.",
        "thumbnail": "An elderly man on the left in a plain porch setting, creator on the right gesturing toward a run-down house, bold on-screen text \"Can I Transform your house?\" as a direct-address caption.",
        "formula": "\"Asking STRANGERS To [Generous Favor]… For FREE\"",
        "why": "Capturing the actual ask (not just the result) lets the viewer watch the stranger's real reaction form, and showing the visible \"before\" state sets up an implicit promise of transformation without spelling it out.",
        "translation": "Reframe \"asking a stranger if I can transform their house for free\" as \"asking a stranger if I can turn their day around for free\" — same direct-address caption format, same visible \"before\" state implying an unstated payoff to come.",
        "ca_title": "Asking Strangers If I Can Turn Their Day Around… For Free",
        "ca_thumbnail": "A woman with a slightly tired, neutral expression on the left in an everyday setting (café or bus stop) as the clear visual anchor, creator on the right gesturing warmly toward her, bold on-screen text \"Can I turn your day around?\" as a direct-address caption.",
        "notes": "The direct-address, on-screen-text-as-caption device (spelling out the literal ask) is a clean, low-production way to set up a payoff without giving it away.",
        "status": "Not Adapted",
    },
    {
        ...
        "views": "11,510,047 (subscriber breakout — qualifies well above the 1M+ absolute view floor)",
        "views_num": 11510047,
        "score": "1M+ views, 51.4x subs",
    ...
    {
        "title": "I Had a Sleepover with My Crush..",
        "channel": "Nico Polo",
        "url": "https://www.youtube.com/watch?v=GNWTt5J7TRo",
        "niche": "Relatable Romantic Comedy",
        "views": "4,716,665 (qualifies via the 1M+ absolute view floor)",
        "views_num": 4716665,
        "score": "1M+ views",
        "pattern": "A cozy, relatable romantic-tension scenario staged with exaggerated comedic reactions rather than a straight, serious romantic tone, making it feel playful and low-stakes to click on.",
        "trigger": "Relatable romantic curiosity (\"what would that actually be like?\") + the safety of exaggerated, comedic framing that makes an intimate scenario feel fun rather than awkward + genuine two-person chemistry visible in the frame.",
        "thumbnail": "A young man and young woman together in bed in matching cozy pajamas, he's holding a rose in his mouth in a playful exaggerated gesture, both wearing exaggerated surprised/awkward expressions, warm string-light bedroom setting — the woman is the clear co-lead of the frame, not a background element.",
        "formula": "\"I Had A [Intimate/Romantic Scenario] With My Crush..\"",
        "why": "The trailing \"..\" implies an unresolved, ongoing situation rather than a single event, the exaggerated comedic expressions signal \"this is fun, not cringe,\" and both people being genuinely visible and reactive sells real chemistry.",
        "translation": "This is already squarely in the cold-approach/dating content niche — the direct lesson is the exaggerated-comedic-tone device, which lowers the stakes of an intimate-feeling thumbnail and makes it feel fun rather than desperate.",
        "ca_title": "I Told A Stranger She Was My Crush Before We'd Even Met..",
        "ca_thumbnail": "Creator and a woman close together outdoors, both with exaggerated playful/surprised expressions rather than serious romantic posing, warm golden-hour lighting, the woman clearly co-leading the frame as an equal with animated, unposed body language.",
        "notes": "The comedic/exaggerated tone (vs. a serious romantic tone) is the actual transferable lesson — it lowers the stakes of an intimate-feeling thumbnail and makes it feel fun rather than desperate.",
        "status": "Not Adapted",
    },
]
