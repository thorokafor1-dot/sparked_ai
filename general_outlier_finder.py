...
KEYWORDS = [
    ...
    "good deed reveal documentary",
    "redemption story documentary",
    "confession story real",
    "apology reveal reaction",
    "forgiveness story documentary",
    "confidence transformation documentary",
    "style transformation reveal",
    "makeover reveal reaction",
    "awkward moment recovery",
    "bold move payoff story",
    "taking a chance story",
    "standing up for someone story",
    "defending someone confrontation",
    "unexpected compliment reaction",
    "stranger's kindness documentary",
    "rags to riches documentary",
    "humble beginnings documentary",
    "surprise proposal reaction",
    "embarrassing moment story",
    "underdog story documentary",
    "against all odds documentary",
    "emotional reunion surprise",
    "random act of kindness caught on camera",
    "karma story real",
    "instant karma caught on camera",
    "revenge story real life",
    "second chance story documentary",
    "life changing moment documentary",
    "wedding surprise reveal",
    "before and after transformation documentary",
    "weight loss journey documentary",
    "small town hero story",
    "paying it forward chain",
    "stranger changed my life story",
