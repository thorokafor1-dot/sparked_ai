...
the Instagram/Facebook automations' profiles) so upload_short.py never conflicts
with your everyday browsing Chrome window/tabs or with the other automations.
Log into the Sparked Thor TikTok account manually in the window this opens,
then close the tab -- the session is saved in that directory for future
automated runs.

Usage:
    python login_chrome_profile.py --chrome-user-data-dir "C:\\path\\to\\dedicated\\dir" --url "https://www.tiktok.com/login"
"""
import argparse
...
def main() -> None:
    ...
    parser.add_argument("--url", default="https://www.tiktok.com/login", help="Page to open for login")
