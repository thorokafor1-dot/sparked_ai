...
## Scope rules
- This folder only handles posting to Instagram. It doesn't decide *what* to post (that's `shorts-research/`) or find outliers (`outlier-tracking/`) — it just takes a finished video and publishes it.
