...
## Core Workflow Rule
- For any multi-step task, always present a written plan first.
- Wait for approval before beginning the work.
- Keep the plan clear, structured, and specific to the requested video project.
...
- Ask for the target audience, style, and video length before drafting content.
