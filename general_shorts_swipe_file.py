...
SWIPE_FILE = [
    ...
    {
        "title": "ترميم منزل مهجور (Restoring an Abandoned House)",
        "channel": "أستكشف أكثر",
        "url": "https://www.youtube.com/watch?v=mu7UKDddQ10",
        "niche": "Forbidden Access/Urban Exploration",
        "views": "5,265,604",
        "views_num": 5265604,
        "score": "411.4x subs",
        "pattern": "Real, unnarrated footage of approaching and entering a forgotten space, letting the visual mystery (why was this abandoned, what's inside) carry the video with minimal explanation.",
        "trigger": "Forbidden curiosity (access to a space the viewer could never see themselves) + an unresolved open loop (why was it left, what's inside) + the massive subscriber breakout (411x) confirming this format travels far beyond a niche exploration audience.",
        "thumbnail": "A real exterior shot of a person walking up to a plain house, overgrown yard visible, minimal on-screen caption, natural daylight, unproduced documentary-style framing.",
        "formula": "\"[Restoring/Exploring] a[n] [Abandoned/Forgotten Place]\"",
        "why": "The format needs almost no packaging trick beyond the premise itself — forbidden access to an abandoned space is inherently curiosity-inducing, and the huge subscriber multiplier shows it can break out of its own niche entirely.",
        "translation": "Reframe \"entering an abandoned house\" as \"approaching someone who seems closed-off/guarded\" — same forbidden-access curiosity and minimal-narration documentary style, aimed at a person instead of a place.",
        "ca_title": "Approaching The Most Closed-Off Looking Girl In The Coffee Shop",
        "ca_thumbnail": "A real exterior/interior shot of the creator approaching a woman who looks guarded or withdrawn, minimal on-screen caption, natural daylight, unproduced documentary-style framing matching the exploration aesthetic.",
        "notes": "This format's strength is restraint — resist over-captioning or over-explaining, since the unnarrated mystery is what's actually working.",
        "status": "Not Adapted",
    },
    {
        "title": "Youtuber Ini Menjebak Para Penipu? (Scam-Baiting)",
        "channel": "DenCma",
        "url": "https://www.youtube.com/watch?v=sfgPH7y65fE",
        "niche": "Scam-Baiting/Justice",
        "views": "914,911",
        "views_num": 914911,
        "score": "36.7x subs",
        "pattern": "A real scam-baiting interaction captured with a live dollar-figure overlay, turning a real con-in-progress into a scoreboard the viewer tracks in real time.",
        "trigger": "Justice/karma satisfaction (watching a scammer's plan unravel) + real-time stakes tracking via the on-screen dollar figure + the authenticity of genuine, unscripted footage.",
        "thumbnail": "Two real people at a table, a bold green dollar figure (\"$345\") overlaid top-left, additional on-screen text labeling the moment, casual indoor setting.",
        "formula": "\"[Creator/Question Framing] [Scam-Baiting Someone]?\"",
        "why": "The live dollar overlay converts an ordinary conversation into a trackable scoreboard, and framing the title as a question (rather than a statement) invites the viewer to find out for themselves rather than being told the outcome.",
        "translation": "Reframe \"tracking money in a scam-baiting interaction\" as \"tracking social stakes in real time during an approach\" — same live-scoreboard-overlay device, applied to a different kind of real-time tension.",
        "ca_title": "Keeping A Live Scoreboard Of How Long She'd Talk To Me",
        "ca_thumbnail": "Creator and a woman mid-conversation on a street, a bold overlay tracking a live count (e.g. a timer or a running tally), casual outdoor daylight setting, candid unposed framing.",
        "notes": "The live-tracking overlay (dollar figure, timer, tally) is a cheap, reusable device for adding trackable real-time stakes to any real interaction.",
        "status": "Not Adapted",
    },
]
