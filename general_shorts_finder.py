...
SHORTS_NATIVE_KEYWORDS = [
    ...
    "unexpected kindness shorts",
    "good deed reveal shorts",
    "redemption story shorts",
    "confession story shorts",
    "apology reveal shorts",
    "forgiveness story shorts",
    "confidence transformation shorts",
    "style transformation shorts",
    "makeover reveal shorts",
    "awkward moment recovery shorts",
    "bold move payoff shorts",
    "taking a chance shorts",
    "standing up for someone shorts",
    "defending someone shorts",
    "unexpected compliment shorts",
    "stranger's kindness shorts",
    "rags to riches shorts",
    "humble beginnings shorts",
    "surprise proposal shorts",
    "embarrassing moment shorts",
    "underdog story shorts",
    "against all odds shorts",
    "emotional reunion shorts",
    "random act of kindness shorts",
    "karma story shorts",
    "instant karma shorts",
